...
export const metadata: Metadata = {
  title: 'Terms of Service | Squared',
  description: 'Terms and conditions for using Squared services.',
}

export default async function TermsPage() {
  const rawContent = await getPageContent('terms')
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold mb-8">
              {content.hero?.headline || 'Terms of Service'}
            </h1>
